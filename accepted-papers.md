...
### [Hierarchical Textual Gradient Optimization for Automatic Prompt Optimization](https://openreview.net/forum?id=VlULgRLlRV)

Averkova Ekaterina, Kulin Nikita

### [Context-Aware Learning Curve Extrapolation with Prior-Data Fitted Networks](https://openreview.net/forum?id=8EttNrLQ8j)

Cheng Yan, Steven Adriaensen, Tom Julian Viering

### [PAVO: Coupling-Aware Resource-Adaptive Routing for ASR → LLM → TTS Inference](https://openreview.net/forum?id=31ONd9BL0C)

NarasingaMoorthy VeiluKanthaPerumal, Mohammed Imthathullah

### [ScAn-Bench: Evaluating Scaling Analysis Methodology](https://openreview.net/forum?id=q6rnd1qRBN)
...
### [From Tables to Runtime: Predicting Algorithm Runtime Distributions with TabPFN](https://openreview.net/forum?id=F1nD8LQBCS)

Hagverdi Ibrahimli, Katharina Eggensperger, Steven Adriaensen

### [Amortized Preferential Bayesian Optimization via Prior-Data Fitted Networks](https://openreview.net/forum?id=BCwiJEZN0F)
